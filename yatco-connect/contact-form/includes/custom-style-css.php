...
function cfp_generate_custom_css($post_id) {
    ...
    $label_margin_top = get_post_meta($post_id, 'cfp_label_margin_top', true);
    $label_margin_right = get_post_meta($post_id, 'cfp_label_margin_right', true);
    $label_margin_bottom = get_post_meta($post_id, 'cfp_label_margin_bottom', true);
    $label_margin_left = get_post_meta($post_id, 'cfp_label_margin_left', true);
    ...
    if ($label_margin_top !='' || $label_margin_right !='' || $label_margin_bottom !='' || $label_margin_left !='') {
        $css .= "    margin: " . 
        (int)$label_margin_top . "px " .
        (int)$label_margin_right . "px " .
        (int)$label_margin_bottom . "px " .
        (int)$label_margin_left . "px;\n";
    }
    $css .= "}\n\n";
    ...
    $input_margin_top = get_post_meta($post_id, 'cfp_input_margin_top', true);
    $input_margin_right = get_post_meta($post_id, 'cfp_input_margin_right', true);
    $input_margin_bottom = get_post_meta($post_id, 'cfp_input_margin_bottom', true);
    $input_margin_left = get_post_meta($post_id, 'cfp_input_margin_left', true);
    ...
    if ($input_margin_top !='' || $input_margin_right !='' || $input_margin_bottom !='' || $input_margin_left !='') {
        $css .= "    margin: " . 
        (int)$input_margin_top . "px " .
        (int)$input_margin_right . "px " .
        (int)$input_margin_bottom . "px " .
        (int)$input_margin_left . "px;\n";
    }
    ...
    if ($input_border_radius_top_left !='' || $input_border_radius_top_right !='' || $input_border_radius_bottom_right !='' || $input_border_radius_bottom_left !='') {
    ...
    $button_margin_top = get_post_meta($post_id, 'cfp_button_margin_top', true);
    $button_margin_right = get_post_meta($post_id, 'cfp_button_margin_right', true);
    $button_margin_bottom = get_post_meta($post_id, 'cfp_button_margin_bottom', true);
    $button_margin_left = get_post_meta($post_id, 'cfp_button_margin_left', true);
    ...
    if ($button_border_radius_top_left !='' || $button_border_radius_top_right !='' || $button_border_radius_bottom_right !='' || $button_border_radius_bottom_left !=''){
    ...
    if ($button_alignment) {
        switch ($button_alignment) {
            case 'left':
                $alignment_value = '10px auto 0 0'; // Align left
                break;
            case 'center':
                $alignment_value = '10px auto 0 auto'; // Align center
                break;
            case 'right':
                $alignment_value = '10px 0 0 auto'; // Align right
                break;
            default:
                $alignment_value = '10px auto 0 auto'; // Default to center
        }
    
        $css .= "display: block; margin: {$alignment_value};";
    }    

    if ($button_margin_top !='' || $button_margin_right !='' || $button_margin_bottom !='' || $button_margin_left !='') {
        $css .= "    margin: " . 
        (int)$button_margin_top . "px " .
        (int)$button_margin_right . "px " .
        (int)$button_margin_bottom . "px " .
        (int)$button_margin_left . "px;\n";
    }
    $css .= "}\n\n";
