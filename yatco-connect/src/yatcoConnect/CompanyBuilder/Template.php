<?php 
	class yatcoConnect_CompanyBuilder_Template {
		...
		public function use_single_template($single_template) {
			...
			if ($wp_query->is_singular) {
				...
				if ($post->post_type == 'yatco_c_builder') {

					$templateToUse = $this->option->getOption('yacht_single_template');			

					if ($templateToUse != 'current') {

						$single_template=YATCO_PLUGIN_DIR.'/src/yatcoConnect/partials/single-yatco-company-builder.php';
