		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
						...
						<div class="yt-row-12">
							<div class="yt-center">
								...
								<h1 class="heading-font-size">
									<?= apply_filters('yatco_seo_heading_brokerage', $data->CompanyName) ?>
								</h1>
								...
								<?php else : ?>
									...
									<p>
										<?= apply_filters('yatco_seo_paragraph_brokerage', $data->CompanyName) ?>
									</p>
				...
				<div class="yt-container section-spacing">
					...
					<h2 class="heading-font-size"><?= $data->CompanyName ?> Yachts for Charter</h2>

					<hr>

					<?php 
						echo do_shortcode('[yatco-js-charter-results CompanyID="'. $data->CompanyID  .'" sort="false" load-more-button="1" pagination=0][/yatco-js-charter-results]');
					?>

					<div style="text-align: center; margin-top: 5px;">
				    	<a href="<?= $options->getOption('charter_search_url'); ?>">
				    		Search For All Charter Yachts
				    	</a>
					</div>
				</div>

				<div class="yt-container section-spacing">
					<h2 class="heading-font-size yt-center"><?= $data->CompanyName ?> - Locations</h2>
					...
					<div class="yt-row">
						<?php foreach ($data->Offices as $company_office) : ?>
							...
							<div class="col-office yt-col-12 yt-col-md-6 yt-col-lg-4" style="height: 120px;">
								<div style="margin-bottom: 15px">
									
									<h4 style="font-weight: bold;"><?= $company_office->OfficeName ?></h4>
									<h5><?= $company_office->LocationCity ?>, <?= $company_office->LocationCountry ?></h5>
				...
				<div class="yt-container" style='margin-bottom: 60px;'>
					...
					<h2 class="heading-font-size"><?= $data->CompanyName ?> - Brokers</h2>
					                ...
					                <div class="card broker">
										...
										<div class="below-picture">
				                            ...
				                            <?php if ($broker->Stats != null) : ?>
					                            <div class="card-title card-name greyfont" style="font-size: 90%; margin-bottom: 60px;">
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5facb08b269b99c1"></script>
